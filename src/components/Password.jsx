    ...
    <InputWrapper width={width} height={height}>
      ...
      <InputContainer>
        ...
        <ToggleButton onClick={() => setIsVisible(!isVisible)}>
          {isVisible ? <InvisibleIcon color={disabled ? "#CCD2D4" : "#334A54"} /> : <VisibleIcon color={disabled ? "#CCD2D4" : "#334A54"} />}
        </ToggleButton>
      </InputContainer>
      {(error || showCounter) && (
        <CounterWrapper>
