...
const RadioButton = ({ label, disabled, error, checked, position = "labelRight" }) => {
  ...
  return (
    <RadioWrapper disabled={disabled} color={textColor}>
      {position === "labelLeft" && <LabelText>{label}</LabelText>}
      <HiddenRadio disabled={disabled} checked={checked} />
      <StyledRadio borderColor={borderColor} innerColor={innerColor} checked={checked} />
